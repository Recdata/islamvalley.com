...
([source code](https://github.com/recdata/chromatastic)) continuously cycles
...
([source code](https://github.com/recdata/color-tailor)) changes the browser theme
...
([source code](https://github.com/recdata/picture-paint)) uses the color palette
